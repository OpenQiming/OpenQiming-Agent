...
class ProviderQuotaExceededError(BaseHTTPException):
    ...
    description = "Your quota for Agent Platform Hosted Model Provider has been exhausted. " \
...
class ProviderModelCurrentlyNotSupportError(BaseHTTPException):
    ...
    description = "Agent Platform Hosted OpenAI trial currently not support the GPT-4 model."
    code = 400
...
class DraftModelConfigNotExist(BaseHTTPException):
    error_code = 'draft_model_config_not_exist'
    description = "Draft model config need to be initialized."
    code = 400


class PublishedModelConfigNotExist(BaseHTTPException):
    error_code = 'published_model_config_not_exist'
    description = "Published model config not exist"
    code = 400
