...
from agent_platform_core.models.db_model.model import App, TraceAppConfig
from agent_platform_core.ops.ops_trace_manager import OpsTraceManager, provider_config_map
...
class OpsService:
    ...
    def get_tracing_app_config(cls, app_id: str, tracing_provider: str):
        ...
        decrypt_tracing_config = OpsTraceManager.decrypt_tracing_config(tenant_id, tracing_provider,
                                                                        trace_config_data.tracing_config)
