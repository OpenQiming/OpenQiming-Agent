...
from agent_platform_core.app.app_config.entities import EasyUIBasedAppConfig
from agent_platform_core.app.entities.app_invoke_entities import ModelConfigWithCredentialsEntity
from agent_platform_core.async_provider_manager import AsyncProviderManager
from agent_platform_core.entities.model_entities import ModelStatus
...
class AsyncModelConfigConverter:
    @classmethod
    async def convert(cls, app_config: EasyUIBasedAppConfig) -> ModelConfigWithCredentialsEntity:
        """
        ...
        provider_model_bundle = await provider_manager.get_provider_model_bundle(
        ...
        if provider_model.status == ModelStatus.NO_CONFIGURE:
            ...
            raise ModelCurrentlyNotSupportError(f"Agent Platform Hosted OpenAI {model_name} currently not support.")
