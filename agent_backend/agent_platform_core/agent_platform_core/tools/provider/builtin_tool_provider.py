...
from agent_platform_core.tools.entities.tool_entities import ToolParameter, ToolProviderCredentials, ToolProviderType
...
from agent_platform_core.tools.entities.tool_entities import ToolProviderEntity
    ...
    def _get_builtin_tools(self) -> list[Tool]:
        ...
        for tool_file in tool_files:
            ...
            assistant_tool_class = load_single_subclass_from_source(
                module_name=f"agent_platform_core.tools.provider.builtin.{provider}.tools.{tool_name}",
