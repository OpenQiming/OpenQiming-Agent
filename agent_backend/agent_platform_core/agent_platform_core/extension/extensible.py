...
from agent_platform_core.helper.position_helper import sort_to_dict_by_position_map
...
class Extensible:
    ...
    def get_position(builtin_file_path: str) -> int:
        position = None
        ...
        for subdir_name in os.listdir(current_dir_path):
            ...
            if os.path.isdir(subdir_path):
                ...
                if '__builtin__' in file_names:
                    ...
                    position = cls.get_position(builtin_file_path)
                elif '__custom_builtin__' in file_names:
                    builtin_file_path = os.path.join(subdir_path, '__custom_builtin__')
                    position = cls.get_position(builtin_file_path)
            ...
            sorted_extensions = sort_to_dict_by_position_map(position_map=position_map, data=extensions,
