...
from agent_platform_service.tasks.annotation.add_annotation_to_index_task import add_annotation_to_index_task
from agent_platform_service.tasks.annotation.batch_import_annotations_task import batch_import_annotations_task
from agent_platform_service.tasks.annotation.delete_annotation_index_task import delete_annotation_index_task
from agent_platform_service.tasks.annotation.disable_annotation_reply_task import disable_annotation_reply_task
from agent_platform_service.tasks.annotation.enable_annotation_reply_task import enable_annotation_reply_task
from agent_platform_service.tasks.annotation.update_annotation_to_index_task import update_annotation_to_index_task
...
class AppAnnotationService:
    ...
    def update_app_annotation_setting(cls, app_id: str, annotation_setting_id: str, args: dict):
        ...
        annotation_setting.updated_at = datetime.datetime.now().replace(tzinfo=None)
