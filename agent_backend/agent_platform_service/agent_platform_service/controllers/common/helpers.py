...
def get_parameters_from_feature_dict(*, features_dict: Mapping[str, Any], user_input_form: list[dict[str, Any]]):
    return {
        ...
        "system_parameters": {
            "image_file_size_limit": agent_platform_config.UPLOAD_IMAGE_FILE_SIZE_LIMIT,
            "video_file_size_limit": agent_platform_config.UPLOAD_VIDEO_FILE_SIZE_LIMIT,
            "audio_file_size_limit": agent_platform_config.UPLOAD_AUDIO_FILE_SIZE_LIMIT,
            "file_size_limit": agent_platform_config.UPLOAD_FILE_SIZE_LIMIT,
            "workflow_file_upload_limit": agent_platform_config.WORKFLOW_FILE_UPLOAD_LIMIT,
        },
        "example": features_dict.get("example", ""),
    }
