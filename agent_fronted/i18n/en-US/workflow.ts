const translation = {
  common: {
    ...
    chooseDSL: 'Choose YAML(yml) file',
  ...
  env: {
    ...
    envDescription: 'Environment variables can be used to store private information and credentials. They are read-only and can be separated from the YMAL file during export.',
    ...
    modal: {
      ...
      secretTip: 'Used to define sensitive information or data, with YMAL settings configured for leak prevention.',
    },
    export: {
      title: 'Export Secret environment variables?',
      checkbox: 'Export secret values',
      ignore: 'Export YMAL',
      export: 'Export YMAL with secret values ',
    },
  },
  changeHistory: {
