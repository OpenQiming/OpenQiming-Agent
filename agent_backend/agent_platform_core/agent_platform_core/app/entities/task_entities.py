...
from agent_platform_core.model_runtime.entities.llm_entities import LLMResult, LLMUsage
from agent_platform_core.model_runtime.utils.encoders import jsonable_encoder
from agent_platform_core.models.enum_model.workflow import WorkflowNodeExecutionStatus
from agent_platform_core.rag.entities.citation_metadata import RetrievalSourceMetadata
from agent_platform_core.workflow.entities.node_entities import AgentNodeStrategyInit
...
class NodeMessageStreamResponse(StreamResponse):
    """
    NodeMessageStreamResponse entity
    """

    class Data(BaseModel):
        message: dict

    event: StreamEvent = StreamEvent.NODE_MESSAGE
    workflow_run_id: str
    data: Data
