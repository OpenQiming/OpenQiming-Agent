...
export type pluginPublishedTo = {
  msg: string | number
  desc: string | number
}
export type pluginPublishedTo1 = {
  msg: string | number
  workspace_id: string | number
}
export type apiAddType = {
  id?: string | number
  interface_name_zh:string
  interface_name_en:string
  api_id:string
  interface_type:string
  eop_protocol:string
  eop_call_address:string
