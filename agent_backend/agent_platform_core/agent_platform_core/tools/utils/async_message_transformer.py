...
from agent_platform_core.file import File, FileTransferMethod, FileType
...
class AsyncToolFileMessageTransformer:
    @classmethod
    async def transform_tool_invoke_messages(
        ...
        for message in messages:
            ...
            if message.type in {ToolInvokeMessage.MessageType.TEXT, ToolInvokeMessage.MessageType.LINK}:
                ...
                try:
                    file = await ToolFileManager.async_create_file_by_url(
                ...
                file = await ToolFileManager.async_create_file_by_raw(
                    user_id=user_id,
                    tenant_id=tenant_id,
