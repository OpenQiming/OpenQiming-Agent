...
from agent_platform_core.model_runtime.callbacks.base_callback import Callback
from agent_platform_core.model_runtime.callbacks.logging_callback import LoggingCallback
from agent_platform_core.model_runtime.entities.llm_entities import LLMMode, LLMResult, LLMResultChunk, LLMResultChunkDelta, LLMUsage
...
class LargeLanguageModel(AIModel):
    ...
    async def async_invoke(
        ...
        if stream and isinstance(result, AsyncGenerator):
            return self._async_invoke_result_generator(
                model=model,
                result=result,
                credentials=credentials,
                prompt_messages=prompt_messages,
...
"""  # noqa: E501
    ...
    async def _async_invoke_result_generator(
        self,
        model: str,
    ...
    @abstractmethod
    async def async_get_num_tokens(
        self,
        model: str,
        credentials: dict,
        prompt_messages: list[PromptMessage],
