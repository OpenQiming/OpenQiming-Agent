...
class PromptMessage(ABC, BaseModel):
    ...
    content: Optional[Union[str, Dict, Sequence["PromptMessageContent"]]] = None
...
class IpythonPromptMessage(PromptMessage):
    """
    Model class for llama ipython prompt message.
    代表工具消息，用于工具执行后将结果交给模型进行下一步计划。
    """
    role: PromptMessageRole = PromptMessageRole.IPYTHON
