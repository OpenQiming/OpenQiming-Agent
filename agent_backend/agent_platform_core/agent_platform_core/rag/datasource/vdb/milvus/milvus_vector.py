...
class MilvusVector(BaseVector):
    ...
    def create_collection(
        ...
        with redis_client.lock(lock_name, timeout=3600):
    ...
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> MilvusVector:
        ...
        return MilvusVector(
            ...
            config=MilvusConfig(
                ...
                password=agent_platform_config.MILVUS_PASSWORD,
                secure=agent_platform_config.MILVUS_SECURE,
                database=agent_platform_config.MILVUS_DATABASE,
            )
        )
