const translation = {
  ...
  auth: {
    ...
    setupModalTitleDescription: '配置憑據後，工作區中的所有成員都可以在編排應用程式時使用此插件。',
  },
  includeToolNum: '包含 {{num}} 個插件',
  addTool: '新增插件',
  createTool: {
    title: '建立自定義插件',
    editAction: '編輯',
    ...
    deleteToolConfirmTitle: '刪除這個插件？',
    deleteToolConfirmContent: '刪除插件是不可逆的。用戶將無法再訪問您的插件。',
  },
  test: {
    title: '測試',
  ...
  noCustomTool: {
    title: '沒有自定義插件!',
    content: '在此統一新增和管理你的自定義插件，方便構建應用時使用。',
    createTool: '建立插件',
  },
  noSearchRes: {
    title: '抱歉，沒有結果！',
    content: '我們找不到任何與您的搜尋相匹配的插件。',
    reset: '重置搜尋',
  },
