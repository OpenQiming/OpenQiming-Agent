...
from agent_platform_core.models.enum_model.workflow import WorkflowNodeExecutionTriggeredFrom
from agent_platform_core.workflow.entities.workflow_node_execution import (
    WorkflowNodeExecution,
    WorkflowNodeExecutionMetadataKey,
    WorkflowNodeExecutionStatus,
)
from agent_platform_core.workflow.nodes.enums import NodeType
from agent_platform_core.workflow.repositories.workflow_node_execution_repository import OrderConfig, WorkflowNodeExecutionRepository
from agent_platform_core.models.db_model.workflow import WorkflowNodeExecution as WorkflowNodeExecutionModel
...
class SQLAlchemyWorkflowNodeExecutionRepository(WorkflowNodeExecutionRepository):
    ...
    def __init__(
        ...
        self._creator_user_role = CreatedByRole.ACCOUNT if isinstance(user, Account) else CreatedByRole.END_USER
