...
from agent_platform_core.model_runtime.entities.text_embedding_entities import (
    EmbeddingUsage,
    TextEmbeddingResult,
)
from agent_platform_core.model_runtime.model_providers.__base.text_embedding_model import (
    TextEmbeddingModel,
)
from agent_platform_core.model_runtime.model_providers.tongyi._common import _CommonTongyi
