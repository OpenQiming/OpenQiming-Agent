...
from agent_platform_core.tools.tool.api_tool import ApiTool
...
from agent_platform_service.fields.model_async.api_tool_provider_async import ApiToolProviderAsync
...
class ApiToolProviderController(ToolProviderController):
    ...
    @staticmethod
    async def from_db_async(db_provider: ApiToolProvider, auth_type: ApiProviderAuthType) -> "ApiToolProviderController":
        credentials_schema = {
            "auth_type": ToolProviderCredentials(
                name="auth_type",
                required=True,
        ...
        user_name = ""
        if db_provider.user_id:
            provider_account = await ApiToolProviderAsync.user_async(db_provider=db_provider)
            user_name = provider_account.name
