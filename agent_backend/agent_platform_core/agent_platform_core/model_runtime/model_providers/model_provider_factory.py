...
from agent_platform_core.helper.module_import_helper import load_single_subclass_from_source
from agent_platform_core.helper.position_helper import get_provider_position_map, sort_to_dict_by_position_map
from agent_platform_core.model_runtime.entities.model_entities import ModelType
from agent_platform_core.model_runtime.entities.provider_entities import ProviderConfig, ProviderEntity, SimpleProviderEntity
from agent_platform_core.model_runtime.model_providers.__base.model_provider import ModelProvider
from agent_platform_core.model_runtime.schema_validators.model_credential_schema_validator import ModelCredentialSchemaValidator
from agent_platform_core.model_runtime.schema_validators.provider_credential_schema_validator import ProviderCredentialSchemaValidator
    ...
    def _get_model_provider_map(self) -> dict[str, ModelProviderExtension]:
        ...
        for model_provider_dir_path in model_provider_dir_paths:
            ...
            model_provider_class = load_single_subclass_from_source(
                module_name=f"agent_platform_core.model_runtime.model_providers.{model_provider_name}.{model_provider_name}",
                script_path=py_path,
