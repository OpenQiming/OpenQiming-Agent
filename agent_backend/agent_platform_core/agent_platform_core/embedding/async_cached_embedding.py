...
from agent_platform_core.models.db_model.dataset import Embedding
from agent_platform_core.rag.datasource.entity.async_embedding import AsyncEmbeddings
from agent_platform_core.rag.datasource.entity.embedding import Embeddings

logger = logging.getLogger(__name__)


class AsyncCacheEmbedding(AsyncEmbeddings):
    def __init__(self, model_instance: AsyncModelInstance, user: Optional[str] = None) -> None:
            ...
            if embedding_queue_indices:
                ...
                try:
                    ...
                    for i in range(0, len(embedding_queue_texts), max_chunks):
                        ...
                        embedding_result = await self._model_instance.invoke_text_embedding(
                            texts=batch_texts,
                            user=self._user,
