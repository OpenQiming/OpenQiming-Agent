...
class ModelConfigManagerAsync:
    ...
    @classmethod
    async def validate_and_set_defaults(cls, tenant_id: str, config: Mapping[str, Any]) -> tuple[dict, list[str]]:
        """
        ...
        models_configurations = await provider_manager.get_configurations(tenant_id)
        models = models_configurations.get_models(
