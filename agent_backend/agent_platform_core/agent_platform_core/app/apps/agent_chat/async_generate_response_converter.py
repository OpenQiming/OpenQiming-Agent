...
class AsyncAgentChatAppGenerateResponseConverter(AsyncAppGenerateResponseConverter):
    ...
    @classmethod
    async def convert_stream_full_response(cls, stream_response: AsyncGenerator[ChatbotAppStreamResponse, None]) \
    ...
    @classmethod
    async def convert_stream_simple_response(cls, stream_response: AsyncGenerator[ChatbotAppStreamResponse, None]) \
            -> AsyncGenerator[str, None]:
        """
