...
from agent_platform_core.plugin.entities.plugin import GenericProviderID, ToolProviderID
from agent_platform_core.plugin.entities.plugin_daemon import PluginBasicBooleanResponse, PluginToolProviderEntity
from agent_platform_core.plugin.impl.base import BasePluginClient
from agent_platform_core.tools.entities.tool_entities import ToolInvokeMessage, ToolParameter
...
class PluginToolManager(BasePluginClient):
    ...
    def invoke(
        ...
        # # credentials json dict 校验
        # if "servers_config" in credentials:
        #     if isinstance(credentials["servers_config"], str):
        #         credentials["servers_config"] = json.dumps(json.loads(credentials["servers_config"]))
                # credentials["servers_config"] = "{\"server_name\": {\"url\": \"http://172.27.221.51:8022/sse\", \"headers\": {}, \"timeout\": 50, \"sse_read_timeout\": 50}}"
