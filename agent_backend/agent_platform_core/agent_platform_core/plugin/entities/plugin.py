...
from agent_platform_core.agent.plugin_entities import AgentStrategyProviderEntity
...
from agent_platform_core.plugin.entities.endpoint import EndpointProviderDeclaration
