...
from agent_platform_basic.exceptions.controllers.service_api.app import NotChatAppError
...
from agent_platform_basic.exceptions.services.message import SuggestedQuestionsAfterAnswerDisabledError
...
class MessageListApi(Resource):
    ...
    def get(self, app_model: App, end_user: EndUser):
        ...
        except ServiceExceptions.message.FirstMessageNotExistsError:
...
class MessageFeedbackApi(Resource):
    ...
    def post(self, app_model: App, end_user: EndUser, message_id):
        ...
        except ServiceExceptions.message.MessageNotExistsError:
