...
from agent_platform_basic.libs.helper import get_remote_ip
from agent_platform_basic.libs.oauth import OAuthUserInfo
...
from agent_platform_service.services.account_service import AccountService, RegisterService, TenantService
from .. import api
...
def _generate_account(provider: str, user_info: OAuthUserInfo):
    ...
    if not account:
        # Create account
        account_name = user_info.name if user_info.name else 'Agent-Platform'
