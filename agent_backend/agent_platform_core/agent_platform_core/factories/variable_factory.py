...
from agent_platform_core.file import File
from agent_platform_core.variables.exc import VariableError
from agent_platform_core.variables.segments import (
    ArrayAnySegment,
    ArrayFileSegment,
    ArrayNumberSegment,
    ArrayObjectSegment,
...
from agent_platform_core.variables.types import SegmentType
from agent_platform_core.variables.variables import (
    ArrayAnyVariable,
    ArrayFileVariable,
    ArrayNumberVariable,
    ArrayObjectVariable,
...
from agent_platform_core.workflow.constants import CONVERSATION_VARIABLE_NODE_ID, ENVIRONMENT_VARIABLE_NODE_ID
...
def _build_variable_from_mapping(*, mapping: Mapping[str, Any], selector: Sequence[str]) -> Variable:
    ...
    if result.size > agent_platform_config.MAX_VARIABLE_SIZE:
        raise VariableError(f"variable size {result.size} exceeds limit {agent_platform_config.MAX_VARIABLE_SIZE}")
