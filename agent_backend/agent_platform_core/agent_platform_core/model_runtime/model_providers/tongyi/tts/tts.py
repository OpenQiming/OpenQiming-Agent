...
from agent_platform_basic.exceptions.model_runtime.invoke import InvokeBadRequestError
...
from agent_platform_core.model_runtime.model_providers.__base.tts_model import TTSModel
    ...
    def validate_credentials(self, model: str, credentials: dict, user: Optional[str] = None) -> None:
        ...
        try:
            self._tts_invoke(
                model=model,
                credentials=credentials,
                content_text='Hello Agent Platform!',
                voice=self._get_model_default_voice(model, credentials),
            )
