...
class SecurityConfig(BaseSettings):
    ...
    AES_SECRET: Optional[str] = Field(
        description='AES Secret Key for encrypting sensitive data',
        default=None,
    )
...
class CodeExecutionSandboxConfig(BaseSettings):
    ...
    CODE_EXECUTION_API_KEY: str = Field(
        ...
        default="agent-platform-sandbox",
    )
...
class RagEtlConfig(BaseSettings):
    ...
    ETL_TYPE: str = Field(
        description="RAG ETL type ('agent_platform' or 'Unstructured'), default to 'agent_platform'",
