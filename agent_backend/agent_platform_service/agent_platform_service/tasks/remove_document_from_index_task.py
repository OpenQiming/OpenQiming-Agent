...
from agent_platform_core.models.db_model.dataset import Document, DocumentSegment
...
def remove_document_from_index_task(document_id: str):
    ...
    try:
        ...
        logging.info(
            click.style('Document removed from index: {} latency: {}'.format(document.id, end_at - start_at),
                        fg='green'))
    except Exception:
