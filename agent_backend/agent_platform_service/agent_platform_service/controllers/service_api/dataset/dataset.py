...
import agent_platform_basic.exceptions.services.dataset as ServiceExceptions
from agent_platform_service.controllers.service_api import api
from agent_platform_basic.exceptions.controllers.service_api.dataset import DatasetInUseError, DatasetNameDuplicateError
from agent_platform_service.controllers.service_api.wraps import DatasetApiResource
...
from agent_platform_service.fields.dataset_fields import dataset_detail_fields
...
class DatasetListApi(DatasetApiResource):
    ...
    def post(self, tenant_id):
        ...
        except ServiceExceptions.DatasetNameDuplicateError:
...
class DatasetApi(DatasetApiResource):
    ...
    def delete(self, _, dataset_id):
        ...
        except ServiceExceptions.DatasetInUseError:
