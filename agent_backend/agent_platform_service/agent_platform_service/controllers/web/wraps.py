...
from agent_platform_basic.exceptions.controllers.web import WebSSOAuthRequiredError
...
from agent_platform_core.models.db_model.model import App, EndUser, Site
...
def decode_jwt_token():
    ...
    try:
        ...
        if auth_scheme != 'bearer':
            raise Unauthorized('Invalid Authorization header format. Expected \'Bearer <api-key>\' format.')
        decoded = PassportService(agent_platform_config).verify(tk)
