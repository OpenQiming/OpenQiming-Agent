const translation = {
  ...
  env: {
    ...
    modal: {
      ...
      secretTip: '用于定义敏感信息或数据，导出 YMAL 时设置了防泄露机制。',
    },
    export: {
      title: '导出 Secret 类型环境变量？',
      checkbox: '导出 secret 值',
      ignore: '导出 YMAL',
      export: '导出包含 Secret 值的 YMAL',
    },
  },
  changeHistory: {
    title: '变更历史',
  ...
  blocksAbout: {
    ...
    'parameter-extractor': '利用 LLM 从自然语言内推理提取出结构化参数，用于后置的插件调用或 HTTP 请求。',
  },
  operator: {
    zoomIn: '放大',
    zoomOut: '缩小',
