...
class AlreadySetupError(BaseHTTPException):
    ...
    description = "Agent Platform has been successfully installed. Please refresh the page or return to the dashboard homepage."
    code = 403
...
class NotSetupError(BaseHTTPException):
    ...
    description = (
        "Agent Platform has not been initialized and installed yet. "
