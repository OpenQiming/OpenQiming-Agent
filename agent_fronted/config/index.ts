...
if (process.env.NEXT_PUBLIC_API_PREFIX && process.env.NEXT_PUBLIC_PUBLIC_API_PREFIX) {
  ...
  // apiPrefix = 'http://127.0.0.1:5001/agent-platform/console/api'//老的ip地址
  // publicApiPrefix = 'http://127.0.0.1:5001/agent-platform/api' // 老的ip地址
  // apiPrefix = 'http://127.0.0.1:5001/console/api'//新的ip地址
  // publicApiPrefix = 'http://127.0.0.1:5001/api' //新的ip地址
  apiPrefix = GlobalUrl.wangyun_NEXT_PUBLIC_API_PREFIX//新的ip地址
  publicApiPrefix = GlobalUrl.wangyun_NEXT_PUBLIC_PUBLIC_API_PREFIX//新的ip地址
}
