...
from agent_platform_core.models.db_model.model import ApiToken, App
from . import api
...
class BaseApiKeyResource(Resource):
    ...
    def delete(self, resource_id, api_key_id):
        ...
        key = db.session.query(ApiToken). \
            filter(getattr(ApiToken, self.resource_id_field) == resource_id, ApiToken.type == self.resource_type,
