...
from agent_platform_basic.exceptions.controllers.console.app import ProviderNotInitializeError
from agent_platform_basic.exceptions.controllers.console.datasets import (
    DatasetInUseError,
...
from agent_platform_core.indexing_runner import IndexingRunner
from agent_platform_core.model_runtime.entities.model_entities import ModelType
from agent_platform_core.models.db_model.dataset import Dataset, Document, DocumentSegment, DatasetPermissionEnum
from agent_platform_core.models.db_model.model import ApiToken, UploadFile
from agent_platform_core.provider_manager import ProviderManager
from agent_platform_core.rag.datasource.vdb.vector_type import VectorType
...
from agent_platform_service.controllers.console.apikey import api_key_fields, api_key_list
...
from agent_platform_service.fields.app_fields import related_app_list
from agent_platform_service.fields.dataset_fields import dataset_detail_fields, dataset_query_detail_fields
from agent_platform_service.fields.document_fields import document_status_fields
from agent_platform_service.services.dataset_service import DatasetService, DocumentService
...
class DatasetListApi(Resource):
    ...
    def get(self):
        ...
        tenant_id = request.args.get('tenant_id', default="", type=str) or current_user.current_tenant_id
    ...
    def post(self):
        ...
        parser.add_argument('name', nullable=False, required=True,
                            ...
                            type=_validate_name)
        parser.add_argument("description", type=str, nullable=True, required=False, default="")
...
class DatasetIndexingEstimateApi(Resource):
    ...
    def post(self):
        ...
        parser.add_argument('doc_language', type=str, default='English', required=False, nullable=False,
                            location='json')
        parser.add_argument('tenant_id', type=str, default='', required=False, nullable=False,
                            location='json')

        args = parser.parse_args()

        tenant_id = args['tenant_id'] or current_user.current_tenant_id
        # validate args
        ...
        try:
            response = indexing_runner.indexing_estimate(tenant_id, extract_settings,
