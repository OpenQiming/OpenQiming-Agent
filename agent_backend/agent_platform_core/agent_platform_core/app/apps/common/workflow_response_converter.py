...
from agent_platform_core.app.entities.app_invoke_entities import AdvancedChatAppGenerateEntity, WorkflowAppGenerateEntity
...
from agent_platform_core.models.db_model.workflow import WorkflowRun, WorkflowNodeExecution
...
from agent_platform_core.workflow.entities.workflow_node_execution import WorkflowNodeExecutionStatus
...
class WorkflowResponseConverter:
    ...
    async def workflow_finish_to_stream_response(
        self,
        *,
        ...
        if workflow_run.created_by_role == CreatedByRole.ACCOUNT:
            ...
            end_user = await session.scalar(stmt)
            if end_user:
                created_by = {
                    "id": end_user.id,
        ...
        return WorkflowFinishStreamResponse(
            ...
            data=WorkflowFinishStreamResponse.Data(
                ...
                files=self.fetch_files_from_node_outputs(workflow_run.outputs_dict),
    ...
    def workflow_node_start_to_stream_response(
        ...
        *,
        ...
        if workflow_node_execution.node_type in {NodeType.ITERATION, NodeType.LOOP}:
            return None
        if not workflow_node_execution.id:
            return None

        response = NodeStartStreamResponse(
            task_id=task_id,
            workflow_run_id=workflow_node_execution.id,
        ...
        *,
        ...
        return NodeFinishStreamResponse(
            ...
            data=NodeFinishStreamResponse.Data(
                ...
                files=self.fetch_files_from_node_outputs(workflow_node_execution.outputs_dict or {}),
                parallel_id=event.parallel_id,
                parallel_start_node_id=event.parallel_start_node_id,
                parent_parallel_id=event.parent_parallel_id,
                parent_parallel_start_node_id=event.parent_parallel_start_node_id,
