...
from agent_platform_core.entities.provider_configuration import ProviderConfiguration
...
from agent_platform_core.model_manager import LBModelManager
...
from agent_platform_core.models.db_model.provider import LoadBalancingModelConfig
        ...
        for config in configs:
            ...
            if config_id:
                ...
                if credentials:
                    ...
                    load_balancing_config.encrypted_config = json.dumps(credentials, ensure_ascii=False)

                load_balancing_config.name = name
                load_balancing_config.enabled = enabled
                load_balancing_config.updated_at = datetime.datetime.now().replace(tzinfo=None)
                db.session.commit()
