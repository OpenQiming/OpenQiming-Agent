...
from agent_platform_core.model_runtime.entities.llm_entities import LLMResult, LLMResultChunk
from agent_platform_core.workflow.entities.node_entities import NodeRunMetadataKey, AgentNodeStrategyInit
from agent_platform_core.workflow.entities.workflow_node_execution import WorkflowNodeExecutionMetadataKey
from agent_platform_core.workflow.graph_engine.entities.graph_runtime_state import GraphRuntimeState
from agent_platform_core.workflow.nodes import NodeType
from agent_platform_core.workflow.nodes.base import BaseNodeData
...
class QueueEvent(StrEnum):
    ...
    STOP = "stop"
    RETRY = "retry"
    WORKFLOW_AGENT_NODE_EVENT = "workflow_agent_node_event"
...
class QueueWorkflowAgentNodeEvent(AppQueueEvent):
    event: QueueEvent = QueueEvent.WORKFLOW_AGENT_NODE_EVENT
    content: str
    cause_by: str
    send_to: str
